...
/**
 * xavierbeast68
 * URL : https://leetcode.com/contest/biweekly-contest-102/problems/find-the-score-of-all-prefixes-of-an-array/
...
public:
    vector<long long> findPrefixScore(vector<int>& nums) {
        ...
        long long curr_max = LONG_MIN, curr_score = 0;
        
        for(long long i : nums){
            curr_max = max(curr_max, i);

            curr_score += (curr_max + i);
            ans.push_back(curr_score);
        }
        return ans;
    }
};
...
void solve(){
    ...
    cin >> nums;
    Solution obj;
    auto ans = obj.findPrefixScore(nums);
    cout << ans << endl;
}
